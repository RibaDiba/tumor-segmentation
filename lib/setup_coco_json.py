...
def setup_rgb(folder_path, coco_json_dir, per_train, per_val, per_test):
    ...
    save_images(train_images, os.path.join(coco_json_dir, 'rgb', 'train', 'images'), base_filename='train_mask')
    save_images(train_masks, os.path.join(coco_json_dir, 'rgb', 'train', 'masks', 'Tumor'), base_filename='train_mask')
    save_images(val_images, os.path.join(coco_json_dir, 'rgb', 'val', 'images'), base_filename='val_mask')
    save_images(val_masks, os.path.join(coco_json_dir, 'rgb', 'val', 'masks', 'Tumor'), base_filename='val_mask')
    save_images(test_images, os.path.join(coco_json_dir, 'rgb', 'test', 'images'), base_filename='test_mask')
...
def setup_grayscale(folder_path, coco_json_dir, per_train, per_val, per_test):
    ...
    save_images(train_images, os.path.join(coco_json_dir, 'grayscale', 'train', 'images'), base_filename='train_mask')
    save_images(train_masks, os.path.join(coco_json_dir, 'grayscale', 'train', 'masks', 'Tumor'), base_filename='train_mask')
    save_images(val_images, os.path.join(coco_json_dir, 'grayscale', 'val', 'images'), base_filename='val_mask')
    save_images(val_masks, os.path.join(coco_json_dir, 'grayscale', 'val', 'masks', 'Tumor'), base_filename='val_mask')
    save_images(test_images, os.path.join(coco_json_dir, 'grayscale', 'test', 'images'), base_filename='test_mask')
...
def setup_rgbd(folder_path, coco_json_dir, per_train, per_val, per_test):
    ...
    save_images(train_images, os.path.join(coco_json_dir, 'rgbd', 'train', 'images'), base_filename='train_mask')
    save_images(train_masks, os.path.join(coco_json_dir, 'rgbd', 'train', 'masks', 'Tumor'), base_filename='train_mask')
    save_images(val_images, os.path.join(coco_json_dir, 'rgbd', 'val', 'images'), base_filename='val_mask')
    save_images(val_masks, os.path.join(coco_json_dir, 'rgbd', 'val', 'masks', 'Tumor'), base_filename='val_mask')
    save_images(test_images, os.path.join(coco_json_dir, 'rgbd', 'test', 'images'), base_filename='test_mask')
