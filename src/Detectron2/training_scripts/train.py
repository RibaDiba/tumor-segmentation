...
d = Dataset(data_path="/projects/PUCHALLA/LLP2024/tumor-segmentation/data/raw_data/useable_data")
...
cfg.OUTPUT_DIR = f"/projects/PUCHALLA/LLP2024/tumor-segmentation/models/detectron2_default_trainer/{cfg.MODELNAME}"
