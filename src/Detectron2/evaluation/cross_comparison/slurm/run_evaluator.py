...
def main(rgb_model, depth_model, rgd_model, output_dir):
    ...
    evaluator = TumorEvaluator(
        ...
        model_root_dir="/projects/PUCHALLA/LLP2024/tumor-segmentation/models/rgb-testing"
    )
...
if __name__ == "__main__": 
    ...
    parser.add_argument("--output", type=str, help="Output dir for failed image comaprisons")
    ...
    main(rgb_model_name, depth_model_name, rgd_model_name, output_dir)