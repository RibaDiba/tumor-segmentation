...
def get_files(type: Type) -> Dict:
    ...
    names_dict = dict()
    train_dirs = get_arr_filenames(os.path.join(root_dir, "train", "images"))
    val_dirs = get_arr_filenames(os.path.join(root_dir, "val", "images"))
    test_dirs = get_arr_filenames(os.path.join(root_dir, "test", "images"))
    ...
    for key in names_dict.keys():
        for dir in names_dict[key]:
            ...
            keep_indices = batched_nms(
                boxes_to_filter, scores_to_filter, classes_to_filter, iou_threshold
            )
