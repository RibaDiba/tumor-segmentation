...
train_mask_path = "./data/coco_json/train_depth/masks"
train_json_path = "./data/coco_json/train_depth/images/train.json"

val_mask_path = "./data/coco_json/val_depth/masks"
val_json_path = "./data/coco_json/val_depth/images/val.json"

test_mask_path = "./data/coco_json/test_depth/masks"
test_json_path = "./data/coco_json/test_depth/images/test.json"
